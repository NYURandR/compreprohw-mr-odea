...
![Linking a project to GitHub](H:/SacklerResearchClass/CompRepro/GitHubImage1.png)
...
If the console looks like this after running a command, hit **ESC.**

![Unfinished Command](H:/SacklerResearchClass/CompRepro/Rprob.png)
